...
int whichWheelPose;
const int servoPot[numServos] = {A0, A1, A2, A3};

const int phases[numUsedServos] = {0, 1, 2, 3};
const int wheelposes[numWheelPose] = {155, 131, 107, 83, 59, 35};

const int forpos[numUsedServos]  = {90, 90, 90, 90};
const int backpos[numUsedServos] = {160, 160, 160, 160};
const int midpos[numUsedServos]  = {90, 90, 90, 90};
const int retrpos[numUsedServos] = {90, 90, 90, 90};
const int TYPE[numUsedServos]    = {SINGLE, SINGLE, SINGLE, SINGLE};
